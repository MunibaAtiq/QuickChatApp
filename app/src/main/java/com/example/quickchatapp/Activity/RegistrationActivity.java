                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful())
                            {
                                ...
                                if (imageUri!=null)
                                {
                                    ...
                                    String status = "Hey There I'm Using This Application";
                                    imageURI="https://firebasestorage.googleapis.com/v0/b/quickchatapp-69137.appspot.com/o/profile_image.png?alt=media&token=75ec1bd7-46da-470f-97da-ab262cb4ea44";
                                    Users users=new Users(auth.getUid(),name,email,imageURI,status);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
